...
DEFAULT_DEM_SERVER = [
	...
	("https://portal.opentopography.org/API/globaldem?demtype=SRTMGL1&west={W}&east={E}&south={S}&north={N}&outputFormat=GTiff&API_Key={API_KEY} http://www.gmrt.org/services/GridServer?west={W}&east={E}&south={S}&north={N}&layer=topo&format=geotiff&resolution=high", 'SRTM 30m and Marine-geo.org GMRT', 'OpenTopography.org web service for SRTM 30m global DEM combined Marine-geo.org web service for GMRT global DEM (terrestrial (ASTER) and bathymetry)')
]
