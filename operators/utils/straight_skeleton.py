...
def checkCounterClockwise(verts):
        """
        ...
        _indices = [i for i in range(len(verts)) if verts[i].y == minY]
        ...
        i = _indices[0] if len(_indices) == 1 else max(_indices, key = lambda i: verts[i].x)
